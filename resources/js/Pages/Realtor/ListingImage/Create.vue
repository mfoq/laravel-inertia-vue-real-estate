  ...
  <Box v-if="listing.images.length" class="mt-4">
    ...
    <section class="mt-4 grid grid-cols-3 gap-4">
      <div v-for="image in listing.images" :key="image.id" class="flex flex-col justify-between">
        ...
        <Link
          :href="route('realtor.listing.image.destroy', {listing: listing, image: image})"
          method="delete"
...
const imageErrors = computed(() => Object.values(form.errors)) //Object.values => to confirm and object to array "array og object values"
...
//هاي عشان البروجرس تاع الفايل ابلود
