<template>
  <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    ...
    <EmptyState v-else class="md:col-span-7 flex items-center">No images to show</EmptyState>
    <div class="md:col-span-5 flex flex-col gap-4">
      ...
      <OfferMade
        v-else-if="user && offerMade"
        :offer="offerMade"
      />

      <Box v-else>
        <Link :href="route('login')" class="font-bold underline">Log in</Link> to make an offer for this Listing
      </Box>
    </div>
  </div>
</template>
